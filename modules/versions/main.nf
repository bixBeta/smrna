process DUMP_VERSIONS {
    // process_mqc rather than process_low: this needs python3 + pyyaml, which
    // the MultiQC image carries and the default pipeline container may not.
    label 'process_mqc'
    ...
    mqc = {
        ...
        "section_href": "https://github.com/bixBeta/smrna",
        "plot_type": "html",
        "data": html,
    }
